...
app.post('/api/crear', async (req, res) => {
    ...
    try {
        ...
        // Verificacion de usuario si ya existe
        ...
        res.status(201).json({
            ...
            data: { NombreUsuario, TipoDocumento, Documento, Rol, Manzana }
        });
...
// Aca obtiene los datos de la persona registrada
...
// ACA EL ADMIN OBTIENE LOS DATOS DE LOS USUARIOS
